...
//CODE HERE
//Many, many tabs of Chrome open to find a simple solution to this that worked. 

function getMatching(zipcode) {
    if(deliveryAreaZipCodes.find(element => element === zipcode)) {
...
// getMatching(11) //delivery no
// getMatching(85206) //delivery yes
...
// CODE HERE
/*Deleted about 50 lines of code trying to make includes work, but now it worked great by leaning on the prior 
problems solution.
*/

function getMatchingTwo(zipcode) {
...
// getMatchingTwo(11) //delivery no
// getMatchingTwo(85206) //delivery yes
...
deals[0].title = deals[0].title.replace('15','10') //.replace('15','10')) ; 

console.log(deals[0].title)
// console.log(deals)


//DON'T MODIFY THIS LINE - Placeholder as success notes. This got me on the right trac. 
...
deals[1].desc = deals[1].desc.replace('March','April') //.replace('March','April')) ; 
